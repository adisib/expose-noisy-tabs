...
let Prefs = function(DEFAULT_PREFS, EXT_NAME) {
    this.defaultPrefs = DEFAULT_PREFS;    
    this.currentPrefs = {};
    
    this.prefsBranch = Services.prefs.getBranch("extensions." + EXT_NAME + ".");
    this.syncBranch = Services.prefs.getBranch("services.sync.prefs.sync.extensions." + EXT_NAME + ".");
